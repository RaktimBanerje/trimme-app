...
const AppointmentCard = ({appointment}) => {
    ...
    return (
        <TouchableOpacity style={{paddingVertical: 10}} activeOpacity={1}>
            <View style={[{width: "100%", borderWidth: 1, borderColor: "#0088E0", borderRadius: 9,  padding: 10, backgroundColor: "white"}]}>
                ...
                <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginVertical: 10,}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                        <FontAwesome name="dollar" size={18} color="#0088E0" />
                    ...
                    {appointment.status === "PENDING" && (
                        ...
                        >
                            {cancelSuccess ? (
                                ...
                                <Text style={{color: "#0088E0"}}>Decline</Text>
                            )}
                        </Button>
                    )}
