        ...
        <SafeAreaView style={{flex: 1}} forceInset={{top: 'alaways'}}>
            <View style={styles.container}>
                <View style={styles.top}>
                    <Image
                        resizeMode="cover" 
                        source={require("../assets/barberbro2.png")}
                    />

                    <Text h2 h2Style={{color: "#4a4a4a"}}>Book your haircut or</Text>
                    <View style={{flexDirection: "row"}}>
                        <Text h2 h2Style={{color: "#4a4a4a"}}>shaving </Text>
                        <Text h2 h2Style={{color: "#0088E0"}}>needs</Text>
                    </View>
